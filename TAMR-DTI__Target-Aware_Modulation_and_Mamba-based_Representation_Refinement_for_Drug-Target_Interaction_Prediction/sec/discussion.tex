...
ablation results are the main evidence for this design choice; the internal
visualizations are best interpreted as diagnostic checks that these modules are
active, not as residue-level binding-site explanations.
...
target-family generalization. Future work should therefore use matched
multi-seed ablations, harder out-of-distribution splits, calibration-aware
threshold selection, and stronger structural supervision when reliable binding
pose or binding-site information is available.
