...
RUNS=(
  "21|datasets/bindingdb|stage2_main_21_full_tamr_dti_n8_bindingdb_seed46|stage2-main-21-full-tamr-dti-n8-bindingdb-seed46"
  "22|datasets/biosnap|stage2_main_22_full_tamr_dti_n8_biosnap_seed46|stage2-main-22-full-tamr-dti-n8-biosnap-seed46"
  "23|datasets/human|stage2_main_23_full_tamr_dti_n8_human_seed46|stage2-main-23-full-tamr-dti-n8-human-seed46"
  "24|datasets/celegans|stage2_main_24_full_tamr_dti_n8_celegans_seed46|stage2-main-24-full-tamr-dti-n8-celegans-seed46"
)
...
run_command() {
  ...
  echo "[stage2-main-seed46 ${index}] ${experiment_name}"
  if [[ "${DRY_RUN}" == "1" ]]; then
    printf '  '
    printf '%q ' "${cmd[@]}"
    printf '\n'
