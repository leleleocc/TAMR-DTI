...
RUNS = [
    ...
    ("BindingDB", 46, "outputs/result/stage2-main-21-full-tamr-dti-n8-bindingdb-seed46/best_metrics.txt"),
    ...
    ("BioSNAP", 46, "outputs/result/stage2-main-22-full-tamr-dti-n8-biosnap-seed46/best_metrics.txt"),
    ...
    ("Human", 46, "swanlog/stage2-main-human-random3-seed46/run-20260527_161626-lqf02lnqgo3d09zksvaqz/backup.swanlab"),
    ...
    ("C. elegans", 46, "outputs/result/stage2-main-24-full-tamr-dti-n8-celegans-seed46/best_metrics.txt"),
]
